...
const AddTPO = async (req, res) => {
  ...
  try {
    ...
    const subject = "Welcome to YIT PLACEMENT | Your Login Credentials as a TPO";
...
const AddManagement = async (req, res) => {
  ...
  try {
    ...
    const subject = "Welcome to YIT PLACEMENT | Your Login Credentials as a Management";
...
const AddStudent = async (req, res) => {
  ...
  try {
    ...
    const subject = "Welcome to YIT PLACEMENT | Your Login Credentials as a Student";
